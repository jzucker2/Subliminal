//
//  SLTableViewCellChildElementsTestsViewController.m
//  Subliminal
//
...
@interface SLTableViewCellChildElementsTestsViewController : SLTestCaseViewController

@end

@interface SLTableViewCellChildElementsTestsViewController () <UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView *tableView;
@property (nonatomic, strong) NSArray *tableViewElements;
@property (nonatomic, strong) NSMutableArray *tableViewFavorites;
@end

@implementation SLTableViewCellChildElementsTestsViewController
